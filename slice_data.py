...
"""
DATA_ROOT_DIR = '/home/lan3/data' # root direction
CLEAN_TRAIN_DIR = 'train_clean_0db'  # where original clean train data exist
NOISY_TRAIN_DIR = 'train_0db'  # where original noisy train data exist
